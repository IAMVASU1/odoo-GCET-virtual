export const users = [
  { id: 1, name: "John Admin", email: "admin@DayFlow.com", role: "Admin", status: "Active", avatar: "JA" },
  { id: 2, name: "Sarah HR", email: "hr@DayFlow.com", role: "HR Officer", status: "Active", avatar: "SH" },
  {
    id: 3,
    name: "Mike Payroll",
  ...
  { id: 4, name: "Emma Johnson", email: "emma@DayFlow.com", role: "Employee", status: "Active", avatar: "EJ" },
  { id: 5, name: "David Smith", email: "david@DayFlow.com", role: "Employee", status: "Active", avatar: "DS" },
]
